...
TE_SPECS = [
    TargetEncodingSpec("te_pitcher_id", ("pitcher_id",), 200),
    TargetEncodingSpec("te_pitcher_batter_hand", ("pitcher_id", "batter_hand"), 250),
    TargetEncodingSpec("te_pitcher_count", ("pitcher_id", "balls_before", "strikes_before"), 350),
    TargetEncodingSpec("te_pitcher_game_type", ("pitcher_id", "game_type"), 300),
    TargetEncodingSpec("te_batter_id", ("batter_id",), 300),
    TargetEncodingSpec("te_batter_pitcher_hand", ("batter_id", "pitcher_hand"), 350),
    TargetEncodingSpec("te_pitcher_team", ("pitcher_team_id",), 1000),
    TargetEncodingSpec("te_batter_team", ("batter_team_id",), 1000),
    TargetEncodingSpec("te_count", ("balls_before", "strikes_before"), 1000),
    TargetEncodingSpec("te_game_pitcher_hand", ("game_type", "pitcher_hand"), 1200),
]
