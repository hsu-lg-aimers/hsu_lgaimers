...
def make_meta_frame(
    ...
    num_cols = [
        "meta_lgbm_pred",
        "meta_catboost_pred",
        "meta_extratrees_pred",
        "meta_raw_pred",
        "meta_calibrated_pred",
        "meta_lgbm_logit",
        "meta_catboost_logit",
        "meta_extratrees_logit",
        "meta_raw_logit",
...
def fit_meta_residual_corrector(
    ...
    meta_x, cat_cols, num_cols = make_meta_frame(x, lgbm_pred, cat_pred, et_pred, raw_pred, calibrated_pred)
...
def apply_meta_residual_corrector(
    ...
    meta_x, _, _ = make_meta_frame(x, lgbm_pred, cat_pred, et_pred, raw_pred, calibrated_pred)
